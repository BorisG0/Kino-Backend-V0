...
public final class CustomerSQL extends MySqlConnector{
    ...
    public Customer[] getCustomerData(){
        ...
        try {
            ...
            while(rs.next()){
                data.add(new Customer(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getInt(5), rs.getString(6), rs.getString(7), 1, rs.getString(8),rs.getString(9), rs.getString(10)));
            }
        }catch (Exception e){
