    ...
    public User getUserFromLoginData(String mailAdress, String password) {
        try {
            ...
            if (rs.next() == true) {
                ...
                if (rs.next() == true){
                    return new User(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getInt(5), rs.getInt(6), rs.getString(7), rs.getString(8), rs.getString(9),rs.getString(10), rs.getString(11));
                }
            }
            return new User();
        } catch (Exception e) {
